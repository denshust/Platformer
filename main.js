...
canvas.height = convertedLevel.length*size+size*4+20;
var FPS = 60;
...
var showCounter = function()
{
    ...
    context.fillRect(25,convertedLevel.length*size,2000,2000);
    context.fillStyle = '#000000';
    context.font = 'normal 70px Arial';
    context.fillText("coins : " +player.points,25,convertedLevel.length*size+size*2);
    context.fillText("health : " +player.health,25,convertedLevel.length*size+size*4);
}
